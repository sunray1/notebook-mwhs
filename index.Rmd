...
```{r message=FALSE, warning=FALSE}
species_lists <- occ %>%
  group_by(name, scientificName, phylum, class, order, family, genus, is_fish, is_coral, category, sequences) %>%
  summarize() %>%
  select(site = name, scientificName, phylum, class, order, family, genus, is_fish, is_coral, iucn_category = category, bold_sequences = sequences) %>%
